...
É complementar aos fluxos 1–3 (que dependem do LLM e/ou do original) e à [correção de gênero por contexto de cena](05-modulo-traducao-llm.md#correção-de-gênero-por-contexto-de-cena-piloto-d) da tradução: aqui o alvo são erros **óbvios** de concordância que já estão na legenda final, sem depender de saber quem fala.
