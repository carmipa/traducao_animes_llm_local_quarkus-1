...
│   │   ├── RespostaLlmTruncadaException.java
...
├── CatracaSeletorDeObraLigadoTest.java
...
│   └── ZeroDeOrdinalEDecimalTest.java
├── arquitetura/
...
│   │   └── RespostaTruncadaNaoEhSucessoTest.java
│   ├── config/
