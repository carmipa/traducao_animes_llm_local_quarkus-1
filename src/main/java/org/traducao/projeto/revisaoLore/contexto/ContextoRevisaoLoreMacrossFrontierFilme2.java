...
/**
 * PROPÓSITO DE NEGÓCIO: Revisao de Lore lean para Macross Frontier: The Wings of Farewell.
 *
 ...
 */
@Component
public class ContextoRevisaoLoreMacrossFrontierFilme2 implements ProvedorPromptRevisaoLore {

    private static final String LORE = """
        - Obra: Macross Frontier: The Wings of Farewell.
        - Regra: nomes canonicos NAO sao localizados. Corrija so grafia de lore.
        - Nomes/termos: Macross Frontier, The Wings, Farewell, Sayonara, Tsubasa, Alto Saotome, Sheryl Nome, Ranka Lee, Michael Blanc, Luca Angeloni, Klan Klang, Ozma Lee, Brera Sterne, Grace, Connor, Naves, Mechas, Durandal, Messiah, Lucifer, Vajra Queen.
    ...
    @Override public String getNomeExibicao() { return "Macross Frontier: The Wings of Farewell - Revisao de Lore"; }
