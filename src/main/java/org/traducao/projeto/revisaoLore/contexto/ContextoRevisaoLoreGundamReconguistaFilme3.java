...
/**
 * PROPÓSITO DE NEGÓCIO: Revisao de Lore lean para Gundam Reconguista in G III: Legacy from Space.
 *
 * <p>INVARIANTES DO DOMÍNIO: derivada da lore de TRADUCAO da mesma obra
 * ({@code contexto.lore.gundam.reconguista.ContextoGundamReconguistaFilme3}) — reestruturacao de
 ...
 */
@Component
public class ContextoRevisaoLoreGundamReconguistaFilme3 implements ProvedorPromptRevisaoLore {
    ...
    private static final String LORE = """
        ...
        - Nomes/termos: Capital Tower, Capital Army, Ameria, Towasanga, Towasangan, Amerian Army, G-Self, G-Arcane, Montero, Mack Knife, Photon Battery, Regild Century, Rayhunton Code, Reconguista.
        - Personagens: Bellri Zenam, Aida Surugan/Aida Rayhunton, Raraiya Monday, Noredo Nug, Klim Nick, Luin Lee/Mask, Mick Jack, Cumpa Rusita, Wilmit Zenam.
    ...
    @Override public String getId() { return "gundam_greco_3"; }
    @Override public String getNomeExibicao() { return "Gundam: Reconguista in G III - Legacy from Space - Revisao de Lore"; }
