...
/**
 * PROPÓSITO DE NEGÓCIO: Revisao de Lore lean para Macross 7 Encore.
 *
 ...
 */
@Component
public class ContextoRevisaoLoreMacross7Encore implements ProvedorPromptRevisaoLore {

    private static final String LORE = """
        - Obra: Macross 7 Encore.
        - Regra: nomes canonicos NAO sao localizados. Corrija so grafia de lore.
        - Nomes/termos: Macross, Encore, OVA, Basara Nekki, Mylene Flare Jenius, Ray Lovelock, Veffidas Feaze, Gamlin Kizaki, Gigil, Sivil, Banda, Fire Bomber.
    ...
    @Override public String getNomeExibicao() { return "Macross 7 Encore - Revisao de Lore"; }
