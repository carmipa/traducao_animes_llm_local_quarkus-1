...
/**
 * PROPÓSITO DE NEGÓCIO: Revisao de Lore lean para Macross DYRL.
 *
...
public class ContextoRevisaoLoreMacrossDYRL implements ProvedorPromptRevisaoLore {
    ...
    private static final String LORE = """
        - Obra: Macross: Do You Remember Love? (Filme 1).
        - Regra: nomes canonicos NAO sao localizados. Corrija so grafia de lore.
        - Nomes/termos: Hikaru Ichijo, Lynn Minmay, Misa Hayase, Roy Focker, Maximilian Jenius,
          Quamzin Kravshera, Valkyrie, Zentradi, SDF-1, GERWALK, Battroid, Fold.
    ...
    @Override public String getNomeExibicao() { return "Macross: Do You Remember Love? (Filme 1) - Revisao de Lore"; }
