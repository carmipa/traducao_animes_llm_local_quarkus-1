...
/**
 * PROPÓSITO DE NEGÓCIO: Revisao de Lore lean para Gundam Reconguista in G II: Bellri's Fierce Charge.
 *
 * <p>INVARIANTES DO DOMÍNIO: derivada da lore de TRADUCAO da mesma obra
 * ({@code contexto.lore.gundam.reconguista.ContextoGundamReconguistaFilme2}) — reestruturacao de
 ...
 */
@Component
public class ContextoRevisaoLoreGundamReconguistaFilme2 implements ProvedorPromptRevisaoLore {
    ...
    private static final String LORE = """
        ...
        - Nomes/termos: Capital Tower, Capital Guard, Capital Army, Ameria, Amerian Army, G-Self, G-Arcane, Montero, Mack Knife, Photon Battery, Regild Century, Reconguista.
        - Personagens: Bellri Zenam, Aida Surugan, Raraiya Monday, Noredo Nug, Klim Nick, Luin Lee/Mask, Mick Jack, Cumpa Rusita, Wilmit Zenam.
    ...
    @Override public String getId() { return "gundam_greco_2"; }
    @Override public String getNomeExibicao() { return "Gundam: Reconguista in G II - Bellri's Fierce Charge - Revisao de Lore"; }
