 ...
 *
 * <p>PROPOSITO DE NEGOCIO: lore do filme V de Gundam Reconguista in G
 * ("Crossing the Line"). O id {@code gundam_greco_5} ja existe em {@code CatalogoObras} com nome de
...
public class ContextoGundamReconguistaFilme5 implements ProvedorContexto {
    ...
    @Override
    public String getId() { return "gundam_greco_5"; }
    @Override
    public String getNomeExibicao() { return "Gundam: Reconguista in G V - Crossing the Line"; }
    @Override
