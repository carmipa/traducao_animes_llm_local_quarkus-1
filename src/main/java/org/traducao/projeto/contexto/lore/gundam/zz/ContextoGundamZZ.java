...
public class ContextoGundamZZ implements ProvedorContexto {
    ...
    private static final String LORE = """
        ...
        - Facções: AEUG, Neo Zeon (Axis), Earth Federation, Karaba, Glemy Faction (cisão interna).
        - Personagens (gênero): Judau Ashta (m) — informal, protetor, matura ao longo da série;
          ...
          Wong Lee (m); Rasara Moon / Sarasa Moon conforme créditos quando aparecerem.
        ...
        - Regras: Judau/Haman/Glemy/Mashymre/Roux grafias oficiais; ZZ Gundam — preferir "ZZ Gundam";
    ...
    public Set<String> termosProtegidos() {
        return Set.of(
            ...
            "Mashymre Cello", "Chara Soon", "Bright Noa", "ZZ Gundam", "Qubeley",
            "Shangri-La", "Argama", "Neo Zeon", "Axis", "Newtype", "Cyber-Newtype",
            "Oldtype", "Minovsky", "Mobile Suit", "Mobile Armor", "Spacenoid"
        );
    }
}
