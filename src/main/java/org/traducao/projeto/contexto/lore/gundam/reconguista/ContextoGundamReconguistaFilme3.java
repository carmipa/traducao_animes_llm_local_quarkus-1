 ...
 *
 * <p>PROPOSITO DE NEGOCIO: lore do filme III de Gundam Reconguista in G
 * ("Legacy from Space"). O id {@code gundam_greco_3} ja existe em {@code CatalogoObras} com nome de
 ...
 */
public class ContextoGundamReconguistaFilme3 implements ProvedorContexto {

    /** VAZIA DE PROPOSITO — ver o Javadoc da classe antes de preencher. */
    private static final String LORE = """
        - Obra: Gundam Reconguista in G III: Legacy from Space.
        - Personagens: Bellri Zenam (homem), Aida Surugan/Aida Rayhunton (mulher), Raraiya Monday (mulher), Noredo Nug (mulher), Klim Nick (homem), Luin Lee/Mask (homem), Mick Jack (mulher), Cumpa Rusita (homem), Wilmit Zenam (mulher).
        - Faccoes: Capital Tower, Capital Army, Ameria, Towasanga.
        - Mobile suits e tecnologia: G-Self, G-Arcane, Montero, Mack Knife, Photon Battery.
        - Termos do mundo: Capital Tower, Photon Battery, Regild Century, Towasanga, Towasangan, Rayhunton Code, Reconguista, Amerian Army. Mantenha nomes proprios em ingles/romanizados. Nao converter "Reconguista" para "Reconquista"; mantenha Reconguista.
        """;

    private static final String PROMPT = ContextoPrompt.montar(
        "Gundam Reconguista in G III: Legacy from Space", LORE);

    @Override
    public String getId() { return "gundam_greco_3"; }
    @Override
    public String getNomeExibicao() { return "Gundam: Reconguista in G III - Legacy from Space"; }
    @Override
