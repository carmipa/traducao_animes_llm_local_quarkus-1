...
public class ContextoDanMachiS4 implements ProvedorContexto {
    ...
    private static final String LORE = """
        ...
        - Regras de nomes: Ryuu/Ryu nao vira "dragao"; Bell Cranel nao vira "sino"; Welf Crozzo nao adaptar; Cassandra, Daphne, Aisha, Haruhime, Mikoto e Marie mantem grafia.
        - Tom: sobrevivencia no Dungeon com trauma, exaustao e tensao; Bell humilde, Ryuu contida/culpada, Cassandra ansiosa/profetica.
        """;
    ...
    public Set<String> termosProtegidos() {
        return Set.of(
            "Bell Cranel", "Hestia", "Ryuu Lion", "Liliruca Arde", "Welf Crozzo",
